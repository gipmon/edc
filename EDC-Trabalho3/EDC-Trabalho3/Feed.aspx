...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <hr />
    <div class="row">
        <asp:XmlDataSource ID="XmlDataSource_feed" runat="server" EnableCaching="false"></asp:XmlDataSource>
    ...
    <asp:FormView ID="feedInfo" runat="server">
        <ItemTemplate>
            <div class="row">
                <div class="col-md-6">
                    <h3>Feed Info</h3>
                ...
                <div class="col-md-6 text-center">
                    ...
                    <div class="row">
        		        ...
        		        <div class="col-xs-4">
        			        <img src="http://placehold.it/160x100" style="height:100px; width:160px" class="img-responsive img-radio">
        		        </div>
                        <div class="col-xs-4"></div>
        	        </div>
                </div>
